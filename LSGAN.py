...
def build_generator(z_dim):
    ...
    model.add(layers.Conv2DTranspose(512, (4,4), strides=(2, 2), padding='same',activation='relu'))
...
def discriminator_loss(real_output, fake_output, smoothing_factor = 0.9):
    ...
    '''
    real_loss = mse(tf.ones_like(real_output)* smoothing_factor, real_output)
...
def summarize_performance(iteration, generator):
    ...
    '''
    filename = 'Generator_model_LSGAN_%03d.h5' % (iteration)
