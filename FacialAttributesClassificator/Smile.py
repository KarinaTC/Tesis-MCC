...
#  Classification Faces with Smile
#  Dataset CelabA pickle,   dictionary with keys [Images,Smiling]
...
datadf = pd.DataFrame(data, columns=['Young'])
...
plt.xticks(index+0.17, ('Sin sonreir', 'Sonriendo'))
plt.legend()
...
cnn = define_model()
cnn.summary()
checkpoint = keras.callbacks.ModelCheckpoint("D:/best_model_Young.hdf5", monitor='loss', verbose=1,save_best_only=True, mode='auto')
